...
HOURS_PER_YEAR = 29200  # timesteps per file in CMIP6 is 29220, 29216 is an exception, last file is 7304
    ...
    for year in tqdm(years):
        ...
        for var in variables:
            ...
            if len(ds[code].shape) == 3:  # surface level variables
                ...
                if year == '201001010600-201501010000': # only 7304 points
                    np_vars[code] = np_vars[code][:7300]
                ...
                for level in all_levels:
                    ...
                    if year == '201001010600-201501010000': # only 7304 points
                        np_vars[f"{code}_{level}"] = np_vars[f"{code}_{level}"][:7300]
        ...
        if year == '201001010600-201501010000': # only 7304 points
            num_shards = num_shards_per_year // 4
        else:
